...
import 'package:yoga_app/poses/AddBatch.dart';
                                                                      ...
                                                                      ButtonBar(
                                                                        children: [
                                                                          ...
                                                                          FlatButton(
                                                                              ...
                                                                              onPressed: () async {
                                                                                await path.update({
                                                                                  '$event': FieldValue.delete()
                                                                                });
                                                                                setState(() {
                                                                                  subscription.remove(event);
                                                                                });
                                                                                Navigator.of(ctx).pop();
                                                                                Fluttertoast.showToast(msg: "Unsubscribed", toastLength: Toast.LENGTH_SHORT, gravity: ToastGravity.CENTER, backgroundColor: Colors.orange[400], textColor: Colors.white, timeInSecForIos: 1);
                                                                              }),
                                                                        ],
                                                                      ),
                                                                    ],
          ...
          floatingActionButton: Visibility(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AddBatch()),
                );
              },
            ),
          ),
