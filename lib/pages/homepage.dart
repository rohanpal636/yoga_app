...
import 'package:yoga_app/configurations/authentication_service.dart';
import 'package:yoga_app/configurations/database_service.dart';
        ...
        builder: (context) =>Scaffold(
          ...
          body: CircularMenu(
            ...
            items: [
              ...
              CircularMenuItem(
                  icon: Icons.logout, color: Colors.blue,onTap: () {
                if (firebaseUser == null) {
                  Navigator.pushNamed(context, '/login');
                  //print(Userdata.data);
                } else {
                  context.read<AuthenticationService>().signOut();
                  context.read<Database>().endData();
                }
              },),
            ],
